shinyServer(function(input, output, session) {
    ...
    observeEvent(input$playlist_go, {
        withBusyIndicatorServer('playlist_go', {
            ...
            playlist_track_audio_features <- get_track_audio_features(playlist_tracks, access_token = spotify_access_token())
            playlist_track_popularity <- get_track_popularity(playlist_tracks, access_token = spotify_access_token())
